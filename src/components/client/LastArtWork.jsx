...
const LastArtWork = (props) => {
    ...
    return (
        ...
        <div className='flex w-3/4 bg-zinc-800 justify-between p-3 h-1/2 rounded-t-lg rounded-bl-lg rounded-br-3xl border border-orange-400  border-opacity-30'>
            ...
            <span className='group flex items-end justify-center w-1/3 m-3 bg-green-300 rounded-xl hover:scale-95 duration-500' style={{ backgroundImage: `url(https://gateway.pinata.cloud/ipfs/${lastArtWork[6]})`, backgroundSize: 'cover' }}>
